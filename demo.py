...
def get_parser():
    ...
    parser.add_argument(
        "--input",
        default="/data/vjuicefs_ai_camera_jgroup_research/11167758/SED/datasets/VOCdevkit/VOC2010/JPEGImages",
        nargs="+",
    ...
    parser.add_argument(
        "--output",
        default="/data/vjuicefs_ai_camera_jgroup_research/11167758/CAT-Seg/vis/pc59",
    ...
    parser.add_argument(
        ...
        default=["MODEL.WEIGHTS", "experiment/base/model_final.pth", 
...
if __name__ == "__main__":
    ...
    args.input = temp
    gt_path = '/data/vjuicefs_ai_camera_jgroup_research/11167758/SED/datasets/VOCdevkit/VOC2010/annotations_detectron2/pc59_val'
    if args.input:
        if len(args.input) == 1:
